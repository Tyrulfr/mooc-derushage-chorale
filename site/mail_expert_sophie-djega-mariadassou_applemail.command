...
set mailSubject to "MOOC L'Esprit d'innover — Sophie DJEGA-MARIADASSOU — confirmation de vos videos expertise pressenties"
set mailBody to "Objet : MOOC L'Esprit d'innover — Sophie DJEGA-MARIADASSOU — confirmation de vos videos expertise pressenties
...
Nous partageons dans le guide de travail les informations utiles sur les intervenants et leurs organismes de rattachement ; vous y apparaissez comme expert(e) proposé(e) (INPI).
...
Selon l'état actuel de la conception, vous êtes proposé(e) sur : Vidéo Expert 8, Vidéo Expert 9.
...
- Capsules témoins concernées : T5.
...
set attachmentPath to POSIX file "/Users/ups_ifpoc/Documents/Temoinage Chorale \"L'esprit D'innover\"/site/guide_editorial_sophie-djega-mariadassou.doc"
