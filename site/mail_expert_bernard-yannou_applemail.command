...
set mailSubject to "MOOC L'Esprit d'innover — Bernard Yannou — confirmation de vos videos expertise pressenties"
set mailBody to "Objet : MOOC L'Esprit d'innover — Bernard Yannou — confirmation de vos videos expertise pressenties
...
Nous partageons dans le guide de travail les informations utiles sur les intervenants et leurs organismes de rattachement ; vous y apparaissez comme expert(e) proposé(e) (CentraleSupélec).
...
Selon l'état actuel de la conception, vous êtes proposé(e) sur : Vidéo Expert 1, Vidéo Expert 2, Vidéo Expert 3, Vidéo Expert 20, Vidéo Expert 21.
...
- Capsules témoins concernées : T1, T2, T11.
...
set attachmentPath to POSIX file "/Users/ups_ifpoc/Documents/Temoinage Chorale \"L'esprit D'innover\"/site/guide_editorial_bernard-yannou.doc"
